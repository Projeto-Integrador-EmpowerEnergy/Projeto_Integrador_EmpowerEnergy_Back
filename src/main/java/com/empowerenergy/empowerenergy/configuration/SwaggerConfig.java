package com.empowerenergy.empowerenergy.configuration;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Projeto Integrador EmpowerEnergy").description("Projeto API Spring - EmpowerEnergy")
				.version("1.0.0").license("Apache License Version 2.0")
				.licenseUrl("https://github.com/Projeto-Integrador-EmpowerEnergy/Projeto_Integrador_EmpowerEnergy.git").contact(contact()).build();
	}
